...
export default function Order() {
  ...
  const result = await fetch(BASE_URL + "seller/order/" + id, {
    headers: {
                  ...
                  <div className="flex flex-col px-4 py-6 md:p-6 xl:p-8 w-full bg-gray-50 dark:bg-[#171717] space-y-6 rounded-lg shadow-xl">
                    <h3 className="text-xl dark:text-gray-300 font-semibold leading-5 text-gray-800">
                      Current Order Status : {
                        order.orderStatus == "Pending" && <span className = "text-red-500"> Pending</span>
                      }
                      {
                        order.orderStatus == "Shipped" && <span className = "text-yellow-500"> Shipped</span>
                      }
                      {
                        order.orderStatus ==  "Delivered" && <span className = "text-green-500"> Delivered</span>
                      }
                    ...
                    <select
                        ...
                        className="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-700 dark:text-gray-200 dark:focus:ring-gray-900 focus:ring-indigo-500 shadow-sm sm:text-sm rounded-md"
                    >
                        <option value="Pending">Pending</option>
                        <option value="Delivered">Delivered</option>
                        <option value="Shipped">Shipped</option>
                    </select>
                    <button className="p-2 mt-4 bg-green-400 rounded-xl text-center w-[240px]" onClick={changeOrderStatus}>Confirm</button>
                    </div>
                </div>
                </div>
